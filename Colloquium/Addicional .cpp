...
//1. Mamy dany zbiór x1,x2,...,xn. Zależy nam na tym, aby funkcja, która otrzyma jako argumenty 2
//indeksy (z tego zbioru) w czasie jak najmniejszym (optymalnie O(log(N)) znalazła minimalną
...
//Proszę przeprowadzić dyskusję na temat zaproponowanej metody wskazując na jej silne oraz słabe strony.
//Dodatkowo trzeba było napisać funkcję dodawania el. do tej tablicy oraz funkcję wyszukującą el. w tablicy.